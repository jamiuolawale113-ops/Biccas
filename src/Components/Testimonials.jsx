...
import amandaAvatar from '../assets/amanda-avatar.jpg';
    ...
    <section className="testimonials-section">
      <div className="testimonials-section__inner">
        <div className="testimonials-section__left">
          ...
          <p className="testimonials-section__subheading">
            Everything you need to accept to payment and grow your money of
            manage anywhere on planet
          </p>

          <div className="testimonial-quote">
            <div className="testimonial-quote__mark">“</div>
            ...
            <p className="testimonial-quote__author">_ Aria Zinanrio</p>
          </div>

          <div className="testimonial-avatars">
            <div className="testimonial-avatars__stack">
              <img 
                src={man1}
                alt="User 1"
                className="testimonial-avatar testimonial-avatar--3" 
                title="user 1" 
              />
              <img 
                src={man2}
            ...
            <button className="testimonial-play-btn" aria-label="Play video testimonial">
              <FiPlay />
            </button>
          </div>
        </div>
        ...
        <div className="testimonials-section__right">
          <div className="cta-card">
            ...
            <form className="cta-card__form" onSubmit={(e) => e.preventDefault()}>
              <div className="cta-card__field">
                <label className="cta-card__label" htmlFor="cta-email">
                  Email
                </label>
                <input
                  id="cta-email"
                  type="email"
                  className="cta-card__input"
              ...
              <div className="cta-card__field">
                <label className="cta-card__label" htmlFor="cta-message">
                  Message
                </label>
                <textarea
                  id="cta-message"
                  className="cta-card__textarea"
                  placeholder="What are you saying?"
                  rows="3"
                ></textarea>
              </div>

              <button type="submit" className="cta-card__btn">
                Request Demo
              </button>

              <p className="cta-card__trial">
                or <a href="#trial" className="cta-card__trial-link">Start Free Trial</a>
              </p>
            </form>
          </div>
        </div>
